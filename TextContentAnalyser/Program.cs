...
namespace TextContentAnalyser // Note: actual namespace depends on the project name.
{
    internal class Program {
        ...
        static int CountWords(string filetext) {
            return filetext.Split(new char[] { }, StringSplitOptions.RemoveEmptyEntries).Length;
        }
